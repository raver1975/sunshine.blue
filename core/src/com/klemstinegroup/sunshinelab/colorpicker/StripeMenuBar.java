...
public class StripeMenuBar extends Table implements StripeMenu {
    ...
    private final PopTable.PopTableStyle popTableStyle;
    ...
    public StripeMenu item(String name, EventListener... listeners) {
        add(createItem(name, Align.center, stripeMenuValues, null, listeners));
        return this;
    }
...
//    }
    ...
    public class StripeMenuValue extends PopTable implements StripeMenu {
        ...
        @Override
        public StripeMenu item(String name, EventListener... listeners) {
            add(createItem(name, Align.left, stripeMenuValues, null, listeners));
            row();
            return this;
        }
