...
public class Statics {
    ...
    public static String IPFSMediaViewerGIF="QmUPnuvGftNx5cojt9gTgqfDJVexXoyNBQKyZhKZTzd3FC";
    public static String IPFSMediaViewerPNG="QmeGeMKoUfUocZqMY7mHxxDmNYovWmFSZtDQj9HnYwy5Hk";
