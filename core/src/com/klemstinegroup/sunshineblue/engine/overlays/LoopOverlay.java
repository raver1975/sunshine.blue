...
//                if (Statics.recframes<SunshineBlue.instance.loopEnd){
                    SunshineBlue.instance.loopEnd=Statics.recframes;
                SunshineBlue.instance.loopStart=0;
...
//        sliderLoopWidth.setRange(0, sliderLoopLength.getValue());
//        sliderLoopWidth.setValue(SunshineBlue.instance.loopEnd - SunshineBlue.instance.loopStart);
//        sliderLoopStart.setRange(0, Math.max(0, Statics.recframes - sliderLoopWidth.getValue()));
    }
