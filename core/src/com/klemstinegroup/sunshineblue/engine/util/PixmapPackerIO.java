...
import static com.klemstinegroup.sunshineblue.engine.util.PixmapPacker.indexPattern;
...
public class PixmapPackerIO {
	...
	public void save (MemoryFileHandle file, PixmapPacker packer) throws IOException {
	 ...
	 * @throws IOException if the atlas file can not be written */	
	public void save (MemoryFileHandle file, PixmapPacker packer, SaveParameters parameters) throws IOException {
