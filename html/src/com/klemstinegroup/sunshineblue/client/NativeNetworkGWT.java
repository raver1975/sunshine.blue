  ...
  return base64
    ...
    .then(function(buffer) {
      ...
      var base64encoded=toBase64(buffer);
        self.@com.klemstinegroup.sunshineblue.client.NativeNetworkGWT::finishDownload(Ljava/lang/String;I)(base64encoded,iii);
    })
...
function toBase64(dataArr){
    ...
    native void uploadToIPFS(String base64, int iii)/*-{
      ...
      if(!($wnd.node && $wnd.node.isOnline()) ){
          ...
          self.@com.klemstinegroup.sunshineblue.client.NativeNetworkGWT::finishUpload(Ljava/lang/String;I)(fileAdded.path,iii);
      });
      }
      };
      run(base64);
